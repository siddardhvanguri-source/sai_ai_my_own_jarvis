...
def open_app_window(url: str):
    """Opens url in dedicated borderless App Mode (Edge/Chrome --app),
    giving a true standalone desktop application experience without
    browser address bar, tabs, or bookmarks."""
    candidates = [
