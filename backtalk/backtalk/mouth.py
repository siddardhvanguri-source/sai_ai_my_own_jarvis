...
class Mouth:
    ...
    def _play_stream(self, sentence: str, directions=None, block: int = 2205,
                     prebuffer_s: float = 0.05):
        """Stream-synthesize and play with minimal 50ms head-start buffer for instant audio start.
        stop() reacts ~50ms. The sample rate comes from
