@echo off
rem barehands -- updating has moved. This script does nothing now.
...
rem can wire it up once, keeping barehands.json:
rem   git init -b main
rem   git remote add origin https://github.com/jaredrhod/barehands
...
echo.
echo       update barehands and tell me what changed
echo.
